...
The Acmekit Admin dashboard supports multiple languages for its interface. Acmekit uses [react-i18next](https://react.i18next.com/) to manage translations in the admin dashboard.
...
import { Button, Container, Heading } from "@acmekit/ui"
...
Learn more about translating admin extensions in the [Translate Admin Customizations](https://docs.acmekitjs.com/learn/fundamentals/admin/translations) documentation.